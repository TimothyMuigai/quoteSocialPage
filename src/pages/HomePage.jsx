  ...
  function HomePage() {
    ...
    const getAllQuotes = async () => {
      try {
        ...
        if (category !== "all") {
          displayQuotes = displayQuotes.filter((displayQuote) =>
            displayQuote.category === category
          );
        }
      ...
      try {
        ...
        setAllQuotes((prevQuotes) =>
          prevQuotes.map((quote) =>
            quote.id === id ? { ...quote, likeSystem: (parseInt(quote.likeSystem) || 0) + 1 } : quote
          )
        );
      } catch (err) {
    ...
    return (
      <div className="home-page">
        ...
        <div className="all-quotes">
          <h2 className="quotes-heading">Inspiring Quotes from other contributors</h2>
